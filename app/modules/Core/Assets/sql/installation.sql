...
(5, 'Test', NULL, 'Displays forms and other structures', 0, 0, NULL, 1);
...
(3, 'test', 'widget', 'Test Widget', 'Displays forms and other structures', '0.4.0', 'WooDzu', 'https://github.com/lantian/PhalconEye', 1, 0, '{"widget_id":"5"}');
